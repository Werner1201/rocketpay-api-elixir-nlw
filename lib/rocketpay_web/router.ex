defmodule RocketpayWeb.Router do
  ...
  #algo para direcionar as rotas para respeitar as regras dessa pipeline
  pipeline :auth do
    # plug eh uma composicao de modulos para facilitar certas funcoes interagirem e modificarem conexoes
